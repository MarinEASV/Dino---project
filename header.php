<?php
// header.php (drop in place of your current <header>…</header>)
$logo = get_field('logo');
?>
<header class="navbar">
  <div class="container d-flex align-items-center">
    ...
    <!-- desktop nav: keep all items on one line -->
    <nav class="nav-links d-flex align-items-center w-100">
      <a href="#menu">Menu</a>
      <a href="#about">Om os</a>
      <a href="#footer">Kontakt</a>
      <button 
        type="button" 
        class="btn custom-reserve-btn rounded-0 ms-4" 
      ...
      <?php if ( function_exists('pll_get_the_languages') ): 
        ...
        if ( $langs ):
          // PHP 7.3-compatible closure version
          $current = reset( array_filter($langs, function($l){ return $l['current_lang']; }) );
          $others  = array_filter($langs, function($l){ return ! $l['current_lang']; });
      ?>
