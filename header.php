...
<div id="mobileMenu" class="mobile-nav">
  ...
  <div class="mobile-menu-inner">
    ...
    <a href="#about">About</a>
    <a href="#footer">Contact</a>
    <button type="button" class="btn custom-reserve-btn rounded-0 mt-2" data-bs-toggle="modal" data-bs-target="#reservationModal">Reserve</button>
    <div id="weglot_here" class="mt-3"></div>
    ...
    <div class="mobile-social mt-5">
      ...
      <a href="https://maps.google.com/?q=Your+Business+Address" target="_blank" aria-label="Location">
